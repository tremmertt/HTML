  ...
  return (
    <div className="container-fluid py-16 mx-auto">
      ...
      <div className="grid md:grid-cols-2 sm:grid-cols-1">
        <img
          className="xl:col-span-1 md:col-span-2 sm:col-span-2 h-auto px-12 py-4 flex justify-center mx-auto"
          src={require("../../img/glassegg-client-map.png")}
          alt=""
        />
        <div className="xl:col-span-1 md:col-span-2 sm:col-span-2 px-12 py-4">
