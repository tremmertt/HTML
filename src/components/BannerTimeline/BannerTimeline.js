    ...
    <div className="container-fluid py-8 mx-auto">
      ...
      <div className="flex justify-center mx-8 leading-4 mt-10 px-5">
        <p className="text-lg md:text-md sm:text-xl font-extralight">
          ...
          ornare massa eget egestas purus viverra. Lacus sed turpis tincidunt
          id. Id diam vel quam elementum pulvinar etiam. Proin nibh nisl
          condimentum id venenatis a. Amet porttitor eget dolor morbi non arcu.
          Vestibulum lectus mauris ultrices eros. Nisl tincidunt eget nullam non
          nisi est sit amet. Purus sit amet volutpat consequat.{" "}
        </p>
      </div>
      <div>
        <Swiper
